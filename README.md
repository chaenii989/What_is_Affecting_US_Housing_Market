...
## Multivariate Linear Regresssion on Time-Series Data with Machine Learning
...
- Predicting average home price with intersts rates, homeownerhsip rate, steel and lumber index, house supply, housing permits authorized, housing units under constructed and constructed.
- Model trained and tested on quaterly data from 1990 to 2021.
- [Results](machine_learning_output/results_ml_multivariate_linear_regression.png)
  - Scores:
...
- Prediction error increases over time, perhaps with the increased volatitlity due to Covid-19.
